                    ...
                    return (
                        <div className="col-12 col-md-2 mb-4" key={i}>
                            <div className="card text-center pt-3 pl-4 pr-4">
                                <img className="card-photo-top" src={user.photo} alt="Card cap" />
                                <div className="card-body">
                                    <h5 className="card-title">{user.name}</h5>
                                    <span className="card-subtitle mb-2 text-muted text-center badge d-flex justify-content-center">{user.email}</span>
